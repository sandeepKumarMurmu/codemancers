...
// importing data
import { Row2IconsData } from "../icon/rowIcons/row2Icons";
import { row2ContactIconData } from "../icon/row2ContactIcon/row2ContactIcon";
// importing components
import { Tags } from "../tag/tag";
import { Operation } from "../operation-contact";
import { PostCard } from "../postCard/post";
import { NavbarSearch } from "../navbarSearch/navbarSearch";
import { CreatePost } from "../createPostInput";
const url =
  ...
  return (
    <div className="row2">
      <div className="row2_child1">
        ...
        <Operation data={Row2IconsData} />
        <div className="row2_grandChild3"></div>
      </div>
      <div className="row2_child2">
        {!postState ? (
          <div
            onClick={() => {
          ...
          <PostCard postState={postState} SetPostState={SetPostState} />
        )}
      </div>
      <div className="row2_child1 ">
